...
from common.protocol.agui.agui_adapter_utils import (
    AGUIAdapterUtils,
    AGUIEvent,
    AGUIEventType,
    RunErrorEvent,
)
from common.protocol.protocol_adapter import ProtocolAdapter
...
class AGUIDefaultAdapter(ProtocolAdapter):
    def __init__(
        ...
        **kwargs,
        ...
        self._execution_func: Optional[Callable[[AgentRequest], AsyncGenerator[Event, None]]] = None
    ...
    async def _handle_requests(
        ...
        logger.info(
            ...
            request_id,
            agent_run_input.model_dump_json(by_alias=True),
        )
        try:
