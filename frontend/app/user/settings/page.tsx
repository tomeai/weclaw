...
import { Upload, Save, User, Mail, Phone, Globe } from "lucide-react"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleInputChange('pushNotifications', checked)}
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked: boolean) => handleInputChange('publicProfile', checked)}
              />
            </div>
          </CardContent>
        </Card>
