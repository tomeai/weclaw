...
Revision ID: 2cc75bdee659
Revises:
Create Date: 2025-10-24 11:17:13.344366
...
def upgrade():
    ...
    op.create_index(op.f('ix_mcp_client_id'), 'mcp_client', ['id'], unique=True)
    op.create_table(
        'mcp_router',
        sa.Column('id', sa.BigInteger(), nullable=False, comment='雪花算法主键 ID'),
    ...
    op.create_table(
        ...
        sa.Column('tool', sa.JSON(), nullable=True, comment='工具列表'),
        sa.Column('knowledge', sa.JSON(), nullable=True, comment='知识库列表'),
        sa.Column('database', sa.JSON(), nullable=True, comment='数据库列表'),
        ...
        sa.Column('created_time', sa.DateTime(timezone=True), nullable=False, comment='创建时间'),
        sa.Column('updated_time', sa.DateTime(timezone=True), nullable=True, comment='更新时间'),
        sa.ForeignKeyConstraint(['category_id'], ['agent_category.id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['user_id'], ['sys_user.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id'),
        comment='agent app',
    )
    op.create_index(op.f('ix_agent_app_id'), 'agent_app', ['id'], unique=True)
    op.create_table(
        'mcp_server',
        sa.Column('id', sa.BigInteger(), nullable=False, comment='雪花算法主键 ID'),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_agent_app_id'), table_name='agent_app')
    ...
    op.drop_index(op.f('ix_mcp_client_id'), table_name='mcp_client')
