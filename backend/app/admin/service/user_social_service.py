...
from app.admin.crud.crud_user_social import user_social_dao
from app.admin.schema.user_social import CreateUserSocialParam
from common.enums import UserSocialAuthType, UserSocialType
    ...
    async def get_binding_auth_url(*, user_id: int, source: UserSocialType) -> str:
        ...
        match source:
            case UserSocialType.github:
                from app.admin.api.v1.oauth.github import github_client
            ...
            case UserSocialType.google:
                from app.admin.api.v1.oauth.google import google_client
