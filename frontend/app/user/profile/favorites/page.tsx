...
import { Clock, ExternalLink, Heart, Search, Star, Users } from "lucide-react"
...
export default function ProfileFavoritesPage() {
  ...
  const filteredMCPs = favoriteMCPs.filter(
    (mcp) =>
      ...
      <div className="space-y-6">
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">总收藏数</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">平均评分</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-2xl font-bold">
                    {favoriteMCPs
                      .reduce((sum, mcp) => sum + mcp.users, 0)
                      .toLocaleString()}
                  </p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">天前更新</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-4">
          {sortedMCPs.length === 0 ? (
            ...
            sortedMCPs.map((mcp) => (
              <Card key={mcp.id} className="transition-shadow hover:shadow-md">
                <CardHeader>
